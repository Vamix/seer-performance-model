...
python3 ./TensorFlow/main.py maxpool

# Conv grad (TensorFlow)
echo "======> collecting Conv (backward) in TensorFlow ......"
python3 ./TensorFlow/main.py conv_grad

# 1x1 Conv op (TensorFlow)
echo "======> collecting 1x1 Conv in TensorFlow ......"
python3 ./TensorFlow/main.py conv_1x1

# Layout transformation (TensorFlow)
echo "======> collecting layout_transform op in TensorFlow ......"
nvprof --print-gpu-trace --log-file ${tmp_results_path}layout python3 ./TensorFlow/main.py layout > ${tmp_results_path}layout_ops
